...
def add_reminder(
    ...
    """
    Add a new remainder to the user's remainder list
...
def update_reminder(index: int, reminder: str, tool_context: ToolContext):
    """
    Update a reminder based on index

    Args:
        index: 1-based index
        reminder: New reminder to update
        tool_context: tool_context to access and update the reminder using 1-based index

    Returns:
        A message of update reminder
    """
    ...
    return {
        ...
        "message": f"Updated reminder {index} from '{old_reminder}' to '{reminder}'",
    }
...
def delete_reminder(index: int, tool_context: ToolContext):
    ...
    Args:
        index: 1-based index to delete the reminder
        tool_context: tool_context to access and delete the reminder from the state
    """
...
def update_user_name(name: str, tool_context: ToolContext):
    ...
    Args:
        ...
        tool_context: tool_context to update the state with new name

    Returns:
        A update confirmation message
    """

    old_user_name = tool_context.state.get("user_name", "")
